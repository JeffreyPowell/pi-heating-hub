...
for result in results_devices:
    ...
    GPIO.output(DEVICE_PIN, NOT(DEVICE_ACTIVE_LEVEL ^ DEVICE_VALUE) )
  
    print( DEVICE_NAME, DEVICE_PIN, DEVICE_ACTIVE_LEVEL, DEVICE_VALUE, NOT(DEVICE_ACTIVE_LEVEL ^ DEVICE_VALUE) )
